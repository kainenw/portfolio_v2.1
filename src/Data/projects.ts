...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: 'A comprehensive mobile ordering solution designed to streamline the food ordering process, reduce errors, and enhance customer experience for restaurants.',
    problem: [
    ...
    impact: [
      {
        ...
        value: '+30%',
        description: 'Order completion rate increased by 30% after launch'
      },
      {
        metric: 'Customer Satisfaction',
        value: '4.6/5',
        description: 'Customer satisfaction scores improved from 3.8 to 4.6/5'
      },
      {
        metric: 'Order Error Rate',
        value: '-60%',
        description: 'Order error rate dropped by 60%'
      }
    ],
    businessResults: {
      conversion: '30% increase in order completion rate',
      userSatisfaction: 'Customer satisfaction improved from 3.8 to 4.6/5',
      efficiency: '60% reduction in order errors'
    },
    businessImpact: [
    ...
    category: 'design',
    links: {
      demo: 'https://docs.google.com/presentation/d/e/2PACX-1vQsushiapp/embed?start=false&loop=false&delayms=3000',
      caseStudy: '/Projects/sushi-app-case-study'
    },
    prototypeEmbed: `<iframe style="border:1px solid #ccc;border-radius:8px" width="100%" height="400" src="https://www.figma.com/embed?embed_host=share&url=https://www.figma.com/proto/sushi-app" allowfullscreen loading="lazy"></iframe>`
  },
  {
    id: '7',
    title: 'Portfolio v2 (Development)',
    slug: 'portfolio-v2-development',
    description: 'A maintainable, scalable portfolio site with improved performance and developer experience.',
    longDescription: 'A complete technical rebuild of my portfolio focusing on modern development practices, performance optimization, and maintainable code architecture.',
    problem: [
      'Previous portfolio lacked scalability and maintainability',
      'Poor performance and developer experience',
      'Outdated technology stack and practices'
    ],
    role: 'Full Stack Developer',
    team: 'Individual project',
    process: [
      'Analyzed current codebase and identified improvement areas',
      'Selected modern technology stack for optimal performance',
      'Implemented best practices for code organization and maintainability',
      'Optimized for performance and SEO'
    ],
    solution: [
      'Built with modern React and Next.js architecture',
    ...
    impact: [
      {
        ...
        value: '95+',
        description: 'Lighthouse performance score improved to 95+'
      },
      {
        metric: 'Load Time',
        value: '-60%',
    ...
    businessResults: {
      efficiency: '60% faster load times',
      users: '95+ Lighthouse performance score'
    },
    businessImpact: [
    ...
    technologies: ['React', 'Next.js', 'TypeScript', 'CSS3', 'Performance Optimization'],
    images: [portfolioImg.src],
    featured: true,
    category: 'development',
    links: {
      repository: 'https://github.com/kainenw/portfolio-v2',
      demo: 'https://kainenwhite.com'
    }
  },
  {
    id: '8',
    ...
    longDescription: 'A modern Reddit client application built to enhance the browsing experience with improved performance, cleaner interface, and better user interactions.',
    problem: [
      'Default Reddit interface can be cluttered and slow',
    ...
    team: 'Individual project',
    process: [
      'Analyzed Reddit API and user interaction patterns',
      'Designed streamlined interface for better usability',
      'Implemented responsive design for all devices',
      'Optimized performance for fast browsing'
    ],
    solution: [
      'Built clean, responsive Reddit client interface',
    ...
    impact: [
      {
        metric: 'Browsing Speed',
        value: '+40%',
        description: 'Faster browsing experience compared to default Reddit'
      },
      {
        metric: 'User Engagement',
        value: '+25%',
        description: 'Increased time spent browsing content'
      },
      {
        metric: 'Mobile Usage',
        value: '+65%',
        description: 'Improved mobile browsing experience'
      }
    ],
    businessResults: {
      efficiency: '40% faster browsing speed',
      users: '25% increase in user engagement'
    },
    businessImpact: [
      'Faster browsing experience compared to default Reddit by 40%',
      'Increased time spent browsing content by 25%',
      'Improved mobile browsing experience by 65%'
    ],
    technologies: ['React', 'Redux', 'Reddit API', 'CSS3', 'Responsive Design'],
    images: [redditImg.src],
    featured: true,
    category: 'development',
    links: {
      repository: 'https://github.com/kainenw/reddit-app',
      demo: 'https://reddit-app-demo.com'
    }
  },
  {
    id: '9',
    title: 'Tonnetz Visualizer',
    slug: 'tonnetz-visualizer',
    ...
    longDescription: 'An interactive music theory visualization tool that helps musicians understand harmonic relationships through the Tonnetz (tone network) representation.',
    problem: [
      'Music theory concepts can be abstract and difficult to visualize',
      'Limited interactive tools for learning harmonic relationships',
      'Traditional music theory education lacks engaging visual elements'
    ],
    role: 'Full Stack Developer & UX Designer',
    team: 'Individual project',
    process: [
      'Researched music theory and Tonnetz mathematical concepts',
      'Designed interactive visualization algorithms',
      'Built responsive web application with audio integration',
      'Tested with musicians and music theory students'
    ],
    solution: [
      'Created interactive Tonnetz visualization system',
      'Implemented real-time harmonic analysis and display',
      'Added audio playback for enhanced learning experience',
      'Built educational features for music theory exploration'
    ],
    impact: [
      {
        metric: 'Learning Efficiency',
        value: '+50%',
        description: 'Improved understanding of harmonic relationships'
      },
      {
        metric: 'User Engagement',
        value: '+70%',
        description: 'Increased time spent exploring music theory'
      },
      {
        metric: 'Educational Value',
        value: '4.8/5',
        description: 'High educational value rating from users'
      }
    ],
    businessResults: {
      users: '50% improvement in learning efficiency',
      userSatisfaction: '4.8/5 educational value rating'
    },
    businessImpact: [
      'Improved understanding of harmonic relationships by 50%',
      'Increased time spent exploring music theory by 70%',
      'High educational value rating of 4.8/5 from users'
    ],
    technologies: ['JavaScript', 'D3.js', 'Web Audio API', 'CSS3', 'Music Theory'],
    images: [tonnetzImg.src],
    featured: true,
    category: 'development',
    links: {
      repository: 'https://github.com/kainenw/tonnetz-visualizer',
      demo: 'https://tonnetz-visualizer.com'
    }
  },
  {
    id: '10',
    ...
    longDescription: 'A comprehensive savings calculator application that helps users plan their financial goals with interactive charts, projections, and goal tracking features.',
    problem: [
      'Complex financial planning tools are intimidating for average users',
      'Lack of visual feedback for savings progress and projections',
      'Difficulty in setting and tracking realistic savings goals'
    ],
    role: 'Frontend Developer',
    team: 'Individual project',
    process: [
      'Researched financial planning best practices and user needs',
      'Designed intuitive interface for complex calculations',
      'Implemented interactive charts and visualization features',
      'Added goal tracking and progress monitoring capabilities'
    ],
    solution: [
      'Built user-friendly savings calculation interface',
      'Implemented interactive charts for financial projections',
      'Added goal setting and progress tracking features',
      'Created educational content for financial literacy'
    ],
    impact: [
      {
        metric: 'User Savings Goals',
        value: '+35%',
        description: 'Increase in users successfully reaching savings targets'
      },
      {
        metric: 'Financial Planning',
        value: '+60%',
        description: 'Improvement in financial planning confidence'
      },
      {
        metric: 'Tool Usage',
        value: '+45%',
        description: 'Regular usage and engagement with the calculator'
      }
    ],
    businessResults: {
      users: '35% increase in successful savings goals',
      userSatisfaction: '60% improvement in financial planning confidence'
    },
    businessImpact: [
      'Increase in users successfully reaching savings targets by 35%',
      'Improvement in financial planning confidence by 60%',
      'Regular usage and engagement with the calculator increased by 45%'
    ],
    technologies: ['React', 'Chart.js', 'Financial APIs', 'CSS3', 'Local Storage'],
    images: [scalcImg.src],
    featured: true,
    category: 'development',
    links: {
      repository: 'https://github.com/kainenw/savings-calculator',
      demo: 'https://savings-calculator-demo.com'
    }
  }
];
